...
void ST7735_DrawPixel(SPI_HandleTypeDef *hspi, uint16_t x, uint16_t y, uint16_t color);
void ST7735_WriteString(SPI_HandleTypeDef *hspi, uint16_t x, uint16_t y, const char* str, FontDef font, uint16_t color, uint16_t bgcolor);
void ST7735_FillRectangle(SPI_HandleTypeDef *hspi, uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t color);
void ST7735_FillScreen(SPI_HandleTypeDef *hspi, uint16_t color);
void ST7735_DrawImage(SPI_HandleTypeDef *hspi, uint16_t x, uint16_t y, uint16_t w, uint16_t h, const uint16_t* data);
void ST7735_InvertColors(SPI_HandleTypeDef *hspi, bool invert);
